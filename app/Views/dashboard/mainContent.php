            ...
            <div class="ms-md-auto d-flex align-items-center">
                <ul class="navbar-nav justify-content-end">
                    ...
                    <li class="nav-item d-flex align-items-center">
                        <a href="javascript:;" class="ms-md-auto nav-link text-body font-weight-bold px-0">
                            <img class="avatar avatar-sm me-2" src="<?= base_url(); ?>../assets/img/default.jpg">
