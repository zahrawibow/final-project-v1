...
<main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ps ps--active-y">
    ...
    <div class="container-fluid py-4">
        ...
        <form action="/maintenance/update/<?= $maintenance['id']; ?>" method="post">
            <?= csrf_field(); ?>
            <div class="row px-3">
                <div class="col-lg-6">
                    <h3>Ubah Perawatan Aset</h3>
                    <p class="text-secondary text-sm">Isi form ubah perawatan untuk mengubah data perawatan aset pada Laboratorium Radiologi dan Kedokteran Nuklir</p>
                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" id="maintenance_name" name="maintenance_name" onfocus="focused(this)" onfocusout="defocused(this)" value="<?= $maintenance['maintenance_name']; ?>">
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="date" id="date" name="date" onfocus="focused(this)" onfocusout="defocused(this)" value="<?= $maintenance['date']; ?>">
                                    </div>
                                </div>
                                <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                    <div class="form-group">
                                        <label for="status">Status</label>
                                        <input class="form-control" type="text" id="status" name="status" onfocus="focused(this)" onfocusout="defocused(this)" value="<?= $maintenance['status']; ?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-sm">
                                    ...
                                    <div class="form-group">
                                        <textarea class="form-control" id="description" name="description" rows="4"><?= $maintenance['description']; ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
