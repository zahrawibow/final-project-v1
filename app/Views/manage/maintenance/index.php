            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                    ...
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">
                        Kelola Perawatan Aset
                    </li>
                </ol>
                <h6 class="font-weight-bolder mb-0">Daftar Perawatan Aset</h6>
            </nav>
                        ...
                        <div class="row">
                            <div class="col-14">
                                <div class="alert alert-dark pb-0" role="alert">
                                    <div class="d-lg-flex">
                                        <div>
                                            <h6 class="text-white mb-0">Tambahkan Perawatan Aset</h6>
                                        ...
                                        <div class="ms-auto my-auto mt-lg-0 mt-4">
                                            <div class="ms-auto my-auto">
                                                <a href="<?= url_to('maintenance.create'); ?>" class="btn bg-gradient-primary btn-sm mb-4" target="_blank">+&nbsp; Tambahkan</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="dataTable-wrapper dataTable-loading no-footer sortable searchable fixed-columns">
                                    <div class="dataTable-container">
                                        <table class="table align-items-center mb-0">
                                            <thead>
                                                <tr>
                                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Nama Perawatan</th>
                                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 align-middle text-center">Aset</th>
                                                    <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Waktu Perawatan</th>
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                <div class="d-flex flex-column">
                                                                    <h6 class="mb-0 text-sm"><?= $m['maintenance_name'] ?></h6>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <p class="text-xs font-weight-bold mb-0 align-middle text-center"><?= $m['name'] ?></p>
                                                        </td>
                                                        <td>
                                                            <p class="text-xs font-weight-bold mb-0 align-middle text-center"><?= $m['date'] ?></p>
                                                        </td>
                                                        <td>
                                                            <p class="text-xs font-weight-bold mb-0 align-middle text-center"><?= $m['description'] ?></p>
                                                        </td>

                                                        <td class="align-middle text-center text-sm">
                                                            <?php if ($m['status']  == "Belum Dilaksanakan") : ?>
                                                                <span class="badge badge-sm bg-gradient-danger"><?= $m['status'] ?></span>
                                                            <?php elseif ($m['status']  == "Sudah Terlaksana") : ?>
                                                                <span class="badge badge-sm bg-gradient-success"><?= $m['status'] ?></span>
                                                            <?php endif; ?>
                                                        </td>

                                                        <td class="align-middle text-center text-sm py-0 px-0">
                                                            <a href="<?= url_to('maintenance.edit', $m['id']); ?>">
                                                                <button type="submit" class="badge badge-sm bg-warning border-0">Ubah</button>
                                                            </a>
                                                        </td>
                                                        <form action="<?= url_to('maintenance.delete', $m['id']); ?>" method="post">
