    ...
    <div class="container-fluid py-4">
        ...
        <form action="/schedule/update/<?= $schedule['id']; ?>" method="post">
            ...
            <div class="row px-3">
                <div class="col-lg-6">
                    <h3>Ubah Agenda</h3>
                    <p class="text-secondary text-sm">Isi form Ubah Agenda untuk Merubah Agenda Kegiatan pada Laboratorium Radiologi dan Kedokteran Nuklir</p>
                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" id="activity_name" name="activity_name" onfocus="focused(this)" onfocusout="defocused(this)" value="<?= $schedule['activity_name']; ?>">
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-12 col-sm-4">
                                    ...
                                    <input class="form-control" type="date" id="date" name="date" onfocus="focused(this)" onfocusout="defocused(this)" value="<?= $schedule['date']; ?>">
                                </div>
                                <div class="form-group col-12 col-sm-4 mt-3 mt-sm-0">
                                    <label class="form-control-label" for="start_time">Waktu Mulai</label>
                                    <input class="form-control" type="time" id="start_time" name="start_time" value="<?= $schedule['start_time']; ?>">
                                </div>
                                <div class="form-group col-12 col-sm-4 mt-3 mt-sm-0">
                                    <label class="form-control-label" for="end_time">Waktu Selesai</label>
                                    <input class="form-control" type="time" id="end_time" name="end_time" value="<?= $schedule['end_time']; ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-12 col-sm-6">
                                    ...
                                    <input class="form-control" type="text" id="activity_location" name="activity_location" onfocus="focused(this)" onfocusout="defocused(this)" value="<?= $schedule['activity_location']; ?>">
                                </div>
                                <div class="form-group col-12 col-sm-6 mt-3 mt-sm-0">
                                    <label class="form-control-label" for="prac_status">Status</label>
                                    <input class="form-control" type="text" id="activity_status" name="activity_status" value="<?= $schedule['activity_status']; ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-sm">
                                    ...
                                    <div class="form-group">
                                        <textarea class="form-control" id="description" name="description" rows="4"><?= $schedule['description']; ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
