<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3" id="sidenav-main">
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html " target="_blank">
            ...
            <span class="ms-1 font-weight-bold">LIS NUCMED </span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <?php if (in_groups('admin')) : ?>
                <!-- admin tab -->
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="https://demos.creative-tim.com/soft-ui-dashboard-pro/pages/dashboards/default.html#dashboardsExamples" class="nav-link active" aria-controls="dashboardsExamples" role="button" aria-expanded="false">
                        ...
                        <span class="nav-link-text ms-1">Pagu Admin</span>
                    </a>
                    <div class="collapse show" id="dashboardsExamples">
                        <ul class="nav ms-4 ps-3">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="<?= url_to('practicum.manage'); ?>">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/">
                    ...
                    <span class="nav-link-text ms-1">Pagu Utama</span>
                </a>
            </li>
            ...
            <!-- practicum bar -->
            <li class="nav-item">
                <a class="nav-link" href="/practicum">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/myprofile">
                    ...
                    <span class="nav-link-text ms-1">Penunjang Akun</span>
                </a>
            </li>
        </ul>
    </div>
        ...
        <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
            ...
            <div class="card-body text-start p-3 w-100">
                ...
                <div class="docs-info">
                    ...
                    <a href="https://www.creative-tim.com/learning-lab/bootstrap/license/soft-ui-dashboard" target="_blank" class="btn btn-white btn-sm w-100 mb-0">Laboratorista</a>
                </div>
            </div>
        </div>
        <a class="btn bg-gradient-primary mt-3 w-100" href="<?= base_url('logout') ?>">Sign out</a>
    </div>
